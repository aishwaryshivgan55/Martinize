...
class martini22:
    ...
    def __init__(self):
        ...
        self.bbtyp    = {                                                                   #                 #@#
                    ...
                    "GYM": spl("Nda   Nda   Nda   Nda   Nda   Nda   Nda   Nda   Nda")
        }                                                                                   #                 #@#
        ## BONDS ##                                                                         #                 
...
AA3     = spl("TRP TYR PHE HIS HIH ARG LYS CYP CYS CYF CYG ASP GLU ILE LEU MET ASN PRO HYP GLN SER THR VAL ALA GLY GYM"+dnares3+rnares3) #@#
AA1     = spl("  W   Y   F   H   H   R   K   J   C   B   X    D   E   I   L   M   N   P   O   Q   S   T   V   A   G   Z"+dnares1+rnares1) #@#
...
# Residue classes:
#lipprot = spl(" CYF")
#protein = AA3[:-8] + lipprot   # remove eight to get rid of DNA/RNA here.
...
#    bb_glym   = "N CA C O HN HA1 HA2"                                                                    #@#
 ...
 #       "GYM":  nsplit(bb), "C1 O C2", "C3 C4 C5 C6", "C7 C8 C9 C10", "C11 C12 C13 C14"),
